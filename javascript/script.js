...
var open_project = document.querySelector(".open_project");
var project_window = document.querySelector(".project");
var app_name_project = document.querySelector("#project");
var close_project = document.querySelector(".close-project");
var backfull_project = document.querySelector(".backfull-project");
var full_project = document.querySelector(".full-project");
var point_project = document.querySelector("#point-project");


var open_books = document.querySelector(".open_books");
var books_window = document.querySelector(".books");
var app_name_books = document.querySelector("#books");
var close_books = document.querySelector(".close-books");
var backfull_books = document.querySelector(".backfull-books");
var full_books = document.querySelector(".full-books");
var point_books = document.querySelector("#point-books");

var open_setting = document.querySelector(".open_setting");
var setting_window = document.querySelector(".setting");
var app_name_setting = document.querySelector("#setting");
var close_setting = document.querySelector(".close-setting");
var backfull_setting = document.querySelector(".backfull-setting");
var full_setting = document.querySelector(".full-setting");
var point_setting = document.querySelector("#point-setting");
...
var create_input = document.createElement("input");
  create_input.placeholder = "Work Experience";
...
full_project.addEventListener("click", () => handleFullScreen(project_window));
full_books.addEventListener("click", () => handleFullScreen(books_window));
full_setting.addEventListener("click", () => handleFullScreen(setting_window));
...
open_setting.addEventListener("click", () =>
  open_window(setting_window, point_setting, app_name_setting)
);
close_setting.addEventListener("click", () =>
  close_window(setting_window, point_setting, app_name_setting)
);
backfull_setting.addEventListener("click", () => handleMinimize(setting_window));


open_books.addEventListener("click", () =>
  open_window(books_window, point_books, app_name_books)
);
close_books.addEventListener("click", () =>
  close_window(books_window, point_books, app_name_books)
);
backfull_books.addEventListener("click", () => handleMinimize(books_window));

open_project.addEventListener("click", () =>
  open_window(project_window, point_project, app_name_project)
);
close_project.addEventListener("click", () =>
  close_window(project_window, point_project, app_name_project)
);
backfull_project.addEventListener("click", () => handleMinimize(project_window));
//calculator code
...
let path = "~";
let dirName;
let dirs = ["Java", "Python", "mySQL", "HTML","CSS","JavaScript","Django","Php","Flutter","SQLAlchemy","Docker","Firebase",];
